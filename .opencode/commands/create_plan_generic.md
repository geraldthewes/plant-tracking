...
**IMPORTANT**: This command is for planning only. You will research the codebase and write a plan file to `knowledge/plans/`, but you MUST NOT modify any source code, configs, or other files outside `knowledge/plans/`. All implementation happens separately via `/implement_plan`. The research sub-agents you spawn (`@codebase-locator`, `@codebase-analyzer`, etc.) are configured as read-only; rely on them for code inspection.
...
1. **Read all mentioned files immediately and FULLY**:
   - Ticket files (e.g., `knowledge/tickets/PROJ-1234.md`)
   - Research documents
...
2. **Spawn initial research sub-agents to gather context**:
   ...
   - If relevant, use `@knowledge-locator` to find any existing knowledge documents about this feature
...
2. **Track research tasks** in a numbered list

3. **Spawn parallel sub-agents for comprehensive research**:
   Invoke multiple agents to research different aspects concurrently:
   ...
   **For historical context:**
   - `@knowledge-locator` - To find any research, plans, or decisions about this area
   - `@knowledge-analyzer` - To extract key insights from the most relevant documents
...
- Original ticket: `knowledge/tickets/PROJ-XXXX.md`
- Related research: `knowledge/research/[relevant].md`
