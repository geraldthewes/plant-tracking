flowchart LR
    ...
    subgraph sys["Plant Tracking System"]
        %% Frontend Container (focus of this diagram)
    ...
    %% Relationships: Gardener to Frontend
    ...
    %% Relationships: Frontend to Backend/Services
    ...
    %% Relationships: Backend to Other Services
    ...
    %% Relationships: Services to External Devices
