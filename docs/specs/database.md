...
The three label fields (`variety_name`, `latin_name`, `planned_planting_date`) are required. All other fields are optional and can be skipped during record creation.
